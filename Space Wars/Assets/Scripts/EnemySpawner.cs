...
public class EnemySpawner : MonoBehaviour
{
    ...
    IEnumerator SpawnEnemies()
    {
        while(true)
        {
            ...
            enemyInstance.GetComponent<Enemy>().start_hitpoints = enemyList[enemychoice].hitpoints;  //push data from scriptable object to instance
            //TO DO FOR START STRENGTH ANS SPEED
